...
|---|---|---|
| Галерея | [models.xedoc.ru](https://models.xedoc.ru/) | Главная страница с публичными 3D-моделями, поиском и комментариями |
| Анимация по тексту | [/animation](https://models.xedoc.ru/animation) | Kimodo SMPL-X RP v1, персонажи для предпросмотра, редактор движений |
...
| Playground | [/playground](https://models.xedoc.ru/playground) | Выравнивание, автоматический или ручной скелет, анимация и ragdoll в WebGL |
| Галерея — прежняя ссылка | [/gallery](https://models.xedoc.ru/gallery) | Та же коллекция моделей и поиск |
| Профили | [/profiles](https://models.xedoc.ru/profiles) | Поиск авторов и их опубликованные генерации |

Model Studio сохраняет положение, поворот и окружение модели: панорамный фон, текстуру и форму земли. Можно выбрать готовую сцену или загрузить свои изображения, просмотреть исходный референс, удалить генерацию и поделиться ссылкой на результат. Получатель ссылки видит готовую модель, движения и сохранённое окружение; исходная картинка и библиотека остаются приватными.
