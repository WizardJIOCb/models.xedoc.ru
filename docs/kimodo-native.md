# Native Kimodo (kimodo.cpp)

Commands in this guide are run from the repository root. For image-to-3D generation and the WebGL playground, see [Model Studio](model-studio.md).
